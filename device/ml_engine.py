...
class MLEngine:
    ...
    def infer(self, waveform: np.ndarray) -> float:
        ...
        Waveform must be a 1D float32 array of exactly 15360 samples at 16kHz.
        """
        ...
        # Output shape is [1, 2] -> [Commercial, Show] based on class folders
        output_data = self.interpreter.get_tensor(self.output_details[0]['index'])
        
        # Because we quantized to int8, we need to dequantize if the output is uint8/int8
